...
use aleph::app::{Engine, FrameRate, Window};
use aleph::gpu::imgui::{im_str, MenuItem, Ui, Condition};
...
impl aleph::app::AppLogic for AlephAppLogic {
    ...
    fn on_update(&mut self, ui: &Ui) {
        ...
        aleph::gpu::imgui::Window::new(im_str!("MainWindow"))
            .size(
        ...
        if frame_timer_open {
            aleph::gpu::imgui::Window::new(im_str!("Frame Time Graph"))

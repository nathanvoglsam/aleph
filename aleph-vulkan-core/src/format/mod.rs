...
///
pub fn format_from_gltf_accessor(accessor: &gltf::Accessor) -> Result<Format, AccessorFormatError> {
...
fn format_scalar(accessor: &gltf::Accessor) -> Result<Format, AccessorFormatError> {
...
fn format_vector2(accessor: &gltf::Accessor) -> Result<Format, AccessorFormatError> {
    match accessor.data_type() {
        ComponentType::I8 => {
            if accessor.normalized() {
...
fn format_vector3(accessor: &gltf::Accessor) -> Result<Format, AccessorFormatError> {
    match accessor.data_type() {
        ComponentType::I8 => {
            if accessor.normalized() {
...
fn format_vector4(accessor: &gltf::Accessor) -> Result<Format, AccessorFormatError> {
    match accessor.data_type() {
        ComponentType::I8 => {
            if accessor.normalized() {

...
#[allow(unused)]
pub fn deferred_deferred_lighting_cs() -> aleph_shader_db::ShaderName<'static, aleph_shader_db::Compute> {
...
#[allow(unused)]
pub fn egui_egui_vert() -> aleph_shader_db::ShaderName<'static, aleph_shader_db::Vertex> {
    unsafe { aleph_shader_db::ShaderName::<aleph_shader_db::Vertex>::new("aleph-render/egui/egui.vert") } // Safety guaranteed by code-gen
}

#[allow(unused)]
pub fn fullscreen_quad_fullscreen_quad_vert() -> aleph_shader_db::ShaderName<'static, aleph_shader_db::Vertex> {
...
#[allow(unused)]
pub fn standard_standard_frag() -> aleph_shader_db::ShaderName<'static, aleph_shader_db::Fragment> {
...
#[allow(unused)]
pub fn standard_standard_vert() -> aleph_shader_db::ShaderName<'static, aleph_shader_db::Vertex> {
...
#[allow(unused)]
pub fn standard_tex_standard_tex_frag() -> aleph_shader_db::ShaderName<'static, aleph_shader_db::Fragment> {
...
#[allow(unused)]
pub fn standard_tex_standard_tex_vert() -> aleph_shader_db::ShaderName<'static, aleph_shader_db::Vertex> {
